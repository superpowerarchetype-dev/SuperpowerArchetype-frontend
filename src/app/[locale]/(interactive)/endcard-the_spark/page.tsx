...
export default function Page() {
    ...
    const t = useTranslations("endcard-the_spark");
    ...
    const shareImage = async () => {
        try {
            const response = await fetch(`/img/sharable_the_spark_${locale}.webp`);
            const blob = await response.blob();
            const file = new File([blob], "sharable_the_spark.webp", { type: blob.type });
        ...
        <motion.div className={cn(notoThai.className, "absolute flex flex-col flex-1 min-h-screen w-full text-[#0A0A0A] bg-[#F0F0F0] overflow-visible overflow-y-scroll overflow-x-hidden")}>
            ...
            <div className="flex flex-col flex-1 pb-[20px] w-full text-[#FFFFFF] bg-[#2C2C2C] px-[20px]">
                ...
                <div className="flex flex-col w-full z-30 px-[20px] pb-[30px] items-center content-center">
                    ...
                    <Image src="/img/character_the_spark.webp" height={200} width={200} alt="character" 
                    className="drop-shadow-[0_0_40px_rgba(255,000,255,0.4)] "/>
                ...
                <motion.div className="flex flex-row h-[200px] w-full bg-white border-[3px] border-black rounded-[4px]">
                    <motion.div className="flex flex-col w-[120px] items-center">
                        <Image src={`/img/sharable_the_spark_${locale}.webp`} height={142} width={100} alt="end card" ref={exportedRef} id="sharable_result" 
                ...
                <div className="border-[2px] border-[#0A0A0A] w-full items-center mt-[20px] rounded-[3px]">
                    ...
                    <div className="px-[20px] bg-white">
                        <div className="flex flex-row gap-x-[5px] pt-[20px]">
                            ...
                            <Image src="/img/element_the_spark.webp" width={20} height={20} alt="element" className="object-contain" />
                        </div>
                        <div className={cn(anuphan.className,"text-[14px] pt-[8px] pb-[20px] text-[#0A0A0A] text-left whitespace-pre-line")}>
                            {t("element.desc")}
                        </div>
                ...
                <div className="border-[2px] border-[#0A0A0A] w-full items-center mt-[20px] rounded-[3px]">
                    <div className="border-b-[2px] pb-[20px] border-[#0A0A0A] bg-white">
                        ...
                        <div className="px-[20px]">
                            <div className="flex flex-col gap-x-[5px] pt-[20px]">
                                ...
                                <Image src="/img/superpower_the_spark.webp" width={125} height={120} alt="superpower" className="object-contain" />
                            </div>
                    ...
                    <div className="px-[20px] border-b-[2px] pb-[20px] border-[#0A0A0A] bg-white">
                        <div className="flex flex-col gap-x-[5px] pt-[20px]">
                            ...
                            <Image src="/img/strength_the_spark.webp" width={120} height={120} alt="strength" className="object-contain" />
                        </div>
                        <div>
                            ...
                            <div className={cn(anuphan.className,"text-[14px] pt-[3px] text-[#0A0A0A] text-left whitespace-pre-line")}>
                                {t("strengths.influenceDesc")}
                            </div>
                            <h1 className={cn(rubik.className,"text-[14px] pt-[12px] text-[#0A0A0A] text-left align-middle font-semibold")}>{t("strengths.example")}</h1>
                            <div className={cn(anuphan.className,"text-[14px] pt-[3px] text-[#0A0A0A] text-left whitespace-pre-line")}>
                                {t("strengths.influenceEx")}
                            </div>
                            
                            <h1 className={cn(anuphan.className,"text-[17px] font-medium pt-[12px] text-[#0A0A0A] text-left align-middle")}>{t("strengths.adaptTitle")}</h1>
                            <div className={cn(anuphan.className,"text-[14px] pt-[3px] text-[#0A0A0A] text-left whitespace-pre-line")}>
                                {t("strengths.adaptDesc")}
                            </div>
                            
                            <h1 className={cn(anuphan.className,"text-[17px] font-medium pt-[12px] text-[#0A0A0A] text-left align-middle")}>{t("strengths.creativeTitle")}</h1>
                            <div className={cn(anuphan.className,"text-[14px] pt-[3px] text-[#0A0A0A] text-left whitespace-pre-line")}>
                                {t("strengths.creativeDesc")}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="px-[20px] border-b-[2px] pb-[20px] border-[#0A0A0A] bg-white">
                        <div className="flex flex-col gap-x-[5px] pt-[20px]">
                            ...
                            <Image src="/img/growth_edge_the_spark.webp" width={143} height={120} alt="growth" className="object-contain" />
                        </div>
                         ...
                         <div className="flex flex-col gap-x-[5px] pt-[20px]">
                            ...
                            { locale === 'th' &&
                                <div className="flex items-center justify-center w-full h-[350px]">
                                    <Image src={`/img/skill_graph_the_spark_${locale}.webp`} width={309} height={309} alt="skill" className="object-cover mt-[40px]" /> 
                                </div>
                            }
                            { locale === 'en' &&
                                <div className="flex items-center justify-center w-full h-[350px]">
                                    <Image src={`/img/skill_graph_the_spark_${locale}.webp`} width={309} height={309} alt="skill" className="object-cover " /> 
                                </div>
                            }
                        </div>
                    </div>
                ...
                <div className="border-[2px] border-[#0A0A0A] w-full items-center mt-[20px] rounded-[3px]">
                    ...
                    <div className="px-[20px] border-b-[2px] border-[#0A0A0A] bg-white">
                        ...
                        <div className="pt-[20px]">
                            ...
                            <Image src="/img/strength_the_flame.webp" width={100} height={120} alt="character" />
                            <div className={cn(anuphan.className,"text-[14px] pt-[8px] pb-[20px] text-[#0A0A0A] text-left whitespace-pre-line")}>
                    ...
                    <div className="px-[20px] bg-white">
                        <div className="flex flex-row gap-x-[5px] pt-[20px]">
                         ...
                         <div className="pt-[20px]">
                            ...
                            <Image src="/img/strength_the_seeder.webp" width={100} height={120} alt="character" className="py-[5px]" />
                            <div className={cn(anuphan.className,"text-[14px] pt-[8px] pb-[20px] text-[#0A0A0A] text-left whitespace-pre-line")}>
                ...
                <div className="border-[2px] border-[#0A0A0A] w-full items-center mt-[20px] pb-[20px] rounded-[3px] bg-white">
                    ...
                    <div className="px-[20px]">
                        ...
                        <ul className={cn(anuphan.className,"text-[14px] pt-[8px] text-[#0A0A0A] text-left")}>
                            ...
                            <li>{t("role.list.2")}</li>
                            <li>{t("role.list.3")}</li>
                            <li className="pl-[10px]">{t("role.list.4")}</li>
                            <li>{t("role.list.5")}</li>
                        </ul>
                    </div>
                </div>
