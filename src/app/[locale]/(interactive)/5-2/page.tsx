...
export default function Page() {
  ...
  return (
    <div className={cn(notoThai.className, "flex flex-col min-h-screen w-full  text-white px-[20px]")}>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.1, delay: 0 }} className="flex flex-col min-h-screen flex-glow">
            ...
            <motion.div className="absolute top-0 left-0 h-screen flex-1 w-full overflow-hidden">
                <motion.div initial={{ x: "-25%" }} animate={{ x: "-55%" }} transition={{delay:0, duration: 10, ease: "easeInOut" }} className="absolute top-0 left-0 h-full flex">
                    <div className="relative w-[2000px] h-full mx-[20px]">
                        <Image src="/img/scene5-2.webp" alt="Scrolling Scene" fill className="object-contain" />
                    </div>
                </motion.div>
            </motion.div>
            <div className="relative flex flex-col-reverse flex-1 pt-[68px]">
                <div className="flex flex-col justify-center pt-[200px] py-[20px] text-[15px] z-10 w-full">
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 5, delay: 0 }} className="pb-[20px]">
                        <h1>{t("stronger")}</h1>
                    </motion.div>
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 5, delay: 5 }}>
                        ...
                        {
                            locale === 'en' &&
                            <h1>you’ve anticipated.</h1>
                        }
                    </motion.div>
                </div>
            </div>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 5, delay: 5 }} className="flex flex-col py-[20px] h-[88px] w-full items-center z-10">
