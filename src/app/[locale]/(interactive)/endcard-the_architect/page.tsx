...
export default function Page() {
    ...
    const t = useTranslations("endcard-the_architect");
    ...
    const shareImage = async () => {
        try {
            const response = await fetch(`/img/sharable_the_architect_${locale}.webp`);
            const blob = await response.blob();
            const file = new File([blob], "sharable_the_architect.webp", { type: blob.type });
        ...
        <motion.div className={cn(notoThai.className, "absolute flex flex-col flex-1 min-h-screen w-full text-[#0A0A0A] bg-[#F0F0F0] overflow-visible overflow-y-scroll overflow-x-hidden")}>
            ...
            <div className="flex flex-col flex-1 pb-[20px] w-full text-[#FFFFFF] bg-[#2C2C2C] px-[20px]">
                ...
                <div className="flex flex-col w-full z-30 px-[20px] pb-[30px] items-center content-center">
                    ...
                    <Image src="/img/character_the_architect.webp" height={200} width={200} alt="character" 
                ...
                <motion.div className="flex flex-row h-[200px] w-full bg-white border-[3px] border-black rounded-[4px]">
                    <motion.div className="flex flex-col w-[120px] items-center">
                        <Image src={`/img/sharable_the_architect_${locale}.webp`} height={142} width={100} alt="end card" ref={exportedRef} id="sharable_result" 
                ...
                <div className="border-[2px] border-[#0A0A0A] w-full items-center mt-[20px] rounded-[3px]">
                    ...
                    <div className="px-[20px] bg-white">
                        <div className="flex flex-row gap-x-[5px] pt-[20px]">
                            ...
                            <Image src="/img/element_the_architect.webp" width={20} height={20} alt="element" className="object-contain" />
                        </div>
                        <div className={cn(anuphan.className,"text-[14px] pt-[8px] pb-[20px] text-[#0A0A0A] text-left whitespace-pre-line")}>
                            {t("element.desc")}
                        </div>
                ...
                <div className="border-[2px] border-[#0A0A0A] w-full items-center mt-[20px] rounded-[3px]">
                    <div className="border-b-[2px] pb-[20px] border-[#0A0A0A] bg-white">
                        ...
                        <div className="px-[20px]">
                            <div className="flex flex-col gap-x-[5px] pt-[20px]">
                                ...
                                <Image src="/img/superpower_the_architect.webp" width={184} height={120} alt="superpower" className="object-contain" />
                            </div>
                    ...
                    <div className="px-[20px] border-b-[2px] pb-[20px] border-[#0A0A0A] bg-white">
                        <div className="flex flex-col gap-x-[5px] pt-[20px]">
                            ...
                            <Image src="/img/strength_the_architect.webp" width={120} height={120} alt="strength" className="object-contain" />
                        </div>
                        <div>
                            ...
                            <h1 className={cn(anuphan.className,"text-[17px] font-medium pt-[12px] text-[#0A0A0A] text-left align-middle")}>{t("strengths.logicTitle")}</h1>
                            <div className={cn(anuphan.className,"text-[14px] pt-[3px] text-[#0A0A0A] text-left whitespace-pre-line")}>
                                {t("strengths.logicDesc")}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="px-[20px] border-b-[2px] pb-[20px] border-[#0A0A0A] bg-white">
                        <div className="flex flex-col gap-x-[5px] pt-[20px]">
                            ...
                            <Image src="/img/growth_edge_the_architect.webp" width={143} height={120} alt="growth" className="object-contain" />
                        </div>
                         ...
                         <div className="flex flex-col gap-x-[5px] pt-[20px]">
                            ...
                            { locale === 'th' &&
                                <div className="flex items-center justify-center w-full h-[350px]">
                                    <Image src={`/img/skill_graph_the_architect_${locale}.webp`} width={309} height={309} alt="skill" className="object-cover mt-[40px]" /> 
                                </div>
                            }
                            { locale === 'en' &&
                                <div className="flex items-center justify-center w-full h-[350px]">
                    ...
                    <div className="px-[20px] bg-white">
                        <div className="flex flex-row gap-x-[5px] pt-[20px]">
                         ...
                         <div className="pt-[20px]">
                            ...
                            <Image src="/img/strength_the_echo.webp" width={100} height={120} alt="character" className="py-[5px]" />
                            <div className={cn(anuphan.className,"text-[14px] pt-[8px] pb-[20px] text-[#0A0A0A] text-left whitespace-pre-line")}>
                                {t("alliance.echoDesc")}
                            </div>
                        </div>
            ...
            {/* Donation Overlay (Trade) */}
            <motion.div className="relative flex flex-col flex-1 items-center justify-center min-h-screen w-full bg-black">
                <div className="absolute w-full h-screen">
                    <Image src="/img/donate_the_architect.webp" alt="donate" fill className="absolute left-[50%] object-cover" priority />
                </div>
                ...
                <div className={cn(anuphan.className,"flex flex-col items-center px-[20px] w-full justify-center text-white text-[17px] font-semobold z-30 gap-y-[20px]")}>
                    ...
                    <Link className="w-full px-[30px] pt-[10px]" href="https://www.amnesty.or.th/petition/petition-for-torture-free-trade-treaty/">
