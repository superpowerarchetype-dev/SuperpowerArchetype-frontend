...
export default function Page() {
  ...
  return (
    <div className={cn(notoThai.className, "relative flex flex-col justify-between bg-[#5D5D5D] items-center w-full h-screen overflow-hidden text-white px-[20px] ")}>
      ...
      <motion.div className="absolute top-0 left-0 flex h-[48px] w-full items-center px-[20px] z-15">
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: duration, delay: 1 }} className="flex flex-col w-full justify-center pt-[68px] text-center text-white flex-1 z-10">
        <h1 className="text-[17px] font-semibold">{t("atmosphere")}</h1>
        <h1 className="text-[17px] font-semibold">{t("strangers")}</h1>
        <h1 className="text-[17px] font-semibold pt-[20px]">{t("approach")}</h1>

        <div className="flex flex-col items-center justify-center text-center pt-[40px] py-[20px] text-[18px] font-light z-10 w-full gap-y-[20px]">
            {/* Choice A */}
      ...
      <motion.div className="h-[200px] z-5">
