...
export default function Page() {
    ...
    return (
      <div className={cn(notoThai.className, "relative flex flex-col justify-between bg-[#FFFFFF] items-center w-full h-screen overflow-hidden text-[#0A0A0A] px-[20px] ")}>
        ...
        <motion.div className="absolute bottom-[30%] h-[50%] w-full z-5">
          <Image src="/img/Q12.webp" alt="scene" fill className="h-[70%] object-contain z-5" priority />
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: duration, delay: 1 }} className="flex flex-col w-full justify-center pt-[88px] text-center flex-1 z-10">
          <h1 className="text-[17px] font-semibold">{t("finalMoment")}</h1>
          <h1 className="text-[17px] font-semibold ">{t("vision")}</h1>
          <h1 className="text-[17px] font-semibold ">{t("whatYouSee")}</h1>
