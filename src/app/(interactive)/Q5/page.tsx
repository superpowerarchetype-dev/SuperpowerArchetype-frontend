  ...
  return (
    <div
      className={cn(
        ...
        "relative flex flex-col justify-between bg-[#2C2C2C] items-center w-full h-screen overflow-hidden text-white px-[20px] "
      )}
    >
      {/* ปุ่มย้อนกลับ */}
      <motion.div 
    ...
    <motion.div 
        ...
        className="absolute bottom-0 h-[80%] w-[80%] z-5">
      <Image
        src="/img/Q5.webp"
        alt="scene"
        fill
    ...
    <motion.div
      ...
      >
        ...
        >
            ...
            >
                <h1>คุณเขียนทุกอย่างที่อัดอั้นอยู่ในใจ</h1>
                <h1>เพื่อให้คุณเห็นความรู้สึกตัวเองให้ชัด</h1>
            </button>
        </div>
        ...
        >
            ...
            >
                <h1>คุณทบทวนสิ่งที่เกิดขึ้นและวางแผนรับมือ</h1>
                <h1>ให้รัดกุมยิ่งขึ้น เพื่อไม่ให้ใครต้องตกอยู่ในอันตรายอีก</h1>
            </button>
        </div>
        ...
        >
            ...
            >
                <h1>ความโกรธแค้นไหลเวียนพล่านไปทั่ว</h1>
                <h1>คุณสับสนและอยากจะทำอะไรสักอย่าง</h1>
                <h1>ให้ความรู้สึกนี้มันสลายไป</h1>
            </button>
        </div>
