  ...
  return (
    ...
    <motion.div
       initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: duration, delay: 1 }}
      className="flex flex-col w-full justify-center pt-[88px]  text-center text-white flex-1 z-10"
      >
        <h1 className="text-[15px] ">วิธีของคุณทำให้ผู้คนเริ่มพูดคุยกัน คืนนั้น</h1>

        <h1 className="text-[17px] font-semibold pt-[20px]">ทุกคนได้เล่าเรื่องของตัวเองกับ</h1>
        <h1 className="text-[17px] font-semibold ">ความพยายามต่อต้าน The Silence...</h1>
        <h1 className="text-[17px] font-semibold ">เรื่องไหนที่โดนใจคุณที่สุด?</h1>
      ...
      >
        ...
        >
            ...
            >
                <h1>เรื่องของ<span className="font-bold"> "นักเล่านิทานเร่ร่อน" </span>ที่มักรวบรวมเด็กๆ</h1>
                <h1>มาแอบฟังเรื่องเล่าจาก 'โลกใบเก่า'</h1>
                <h1>โลกที่เต็มไปด้วยเสียงหัวเราะและสีสันที่พวกเขา</h1>
                <h1>ไม่เคยเห็น</h1>
            </button>
        </div>
