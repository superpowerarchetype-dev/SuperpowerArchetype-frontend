  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        <Link href="/Q2" className="flex flex-row items-center text-[#0A0A0A]">
      ...
      >
        <h1>คุณรู้ว่าแค่พลังของคุณย่อมไม่เพียงพอ เพื่อหาแนวร่วม</h1>
        <h1>คุณต้องปลุกชาวเมืองให้ตื่นรู้และเข้าร่วมการต่อต้าน</h1>
        <h1>คุณจะใช้วิธีไหนรวมใจผู้คน?</h1>
      </motion.div>
      ...
      >
        ...
        >
            ...
            >
                <h1>คุณจะชวนทุกคนที่คุณรู้จักออกมารวมตัวกัน</h1>
                <h1>สร้างแฟลชม็อบแห่งสีสันที่ไม่มีใครวางแผน</h1>
            </button>
        </div>
        ...
        >
            ...
            >
                <h1>คุณออกแบบโครงสร้างขบวนการอย่างเป็น</h1>
                <h1>ระบบ และแผนสำรองทุกทางหนีทีไล่</h1>
            </button>
        </div>
        ...
        >
            ...
            >
                <h1>คุณก้าวขึ้นเวทีปราศรัยด้วยถ้อยคำที่ปลุกเร้า</h1>
                <h1>และทรงพลัง พร้อมจุดไฟในใจผู้คนให้ลุกโชน</h1>
            </button>
        </div>
