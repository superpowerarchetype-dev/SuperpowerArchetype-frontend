        ...
        <div className="flex flex-col flex-1 w-full pt-[88px] justify-center">
            ...
            <div className="flex flex-col  justify-center">
                ...
                <motion.div
                    ...
                    className="flex flex-col flex-1 items-left justify-center text-left gap-y-[3px] py-[20px] text-[18px] z-10 w-full"
                >
                    <motion.div
                        initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    ...
                    >
                        <h1 className="font-semibold text-[18px] ">เช้าวันถัดมา</h1>
                    </motion.div>
                    <motion.div
                        initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    ...
                    >
                        <h1 className="font-semibold text-[18px] ">500 เมตรจากหอควบคุม</h1>
                    </motion.div>
