...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      className="pt-[68px] font-semibold text-[17px] text-center text-[#0A0A0A]"
      >
        <h1>"ทำไม" ต้องเป็นคุณ?</h1>
        <h1>และทำไมต้องเป็น "ตอนนี้"?</h1>
        <h1>ความคิดไหนทำให้หัวใจคุณเต้นแรงที่สุด</h1>
      </motion.div>
      ...
      >
        ...
        >
            ...
            >
                <h1>เพราะคุณรู้ดีว่านี่ไม่ใช่เรื่องถูกต้อง </h1>
                <h1>มันเป็นหน้าที่ของคุณที่ต้องส่งต่อ</h1>
                <h1>ความรู้สึกนี้ให้ผู้คน</h1>
            </button>
        </div>
        ...
        >
            ...
            >
                <h1>เพราะปัญหาตรงหน้าไม่ใช่เรื่องใหม่ และถ้าไม่แก้ </h1>
                <h1>มันก็จะพังวนซ้ำไปอีก</h1>
            </button>
        </div>
