...
export default function Page() {
  ...
  return (
    ...
    <motion.div 
        ...
        className="absolute bottom-[0%] h-full w-full z-5">
      <Image
        src="/img/Q10.webp"
        alt="scene"
        fill
        className="h-[70%] object-cover z-5"
        priority
      />
    </motion.div>
    <motion.div
      ...
      >
        ...
        <h1 className="text-[17px] font-semibold">เพื่อนร่วมทีมเริ่มเสียกำลังใจ ...</h1>
        <h1 className="text-[17px] font-semibold ">คุณจะพูดอะไรให้เขาฟัง?</h1>
      ...
      >
        ...
        >
            ...
            >
                <h1>"อย่าไปเชื่อมัน! ที่มันทำแบบนี้ก็เพราะมันกลัวเรา!</h1>
                <h1>มาทำให้มันเห็นว่าเรามุ่งมั่นแค่ไหน!"</h1>
            </button>
        </div>
        ...
        >
            ...
            >
                <h1>“ทุกคนหายใจลึกๆ นะ เราจะไม่ทิ้งใครไว้ข้างหลัง </h1>
                <h1>พวกเราจะผ่านพ้นมันไปด้วยกัน"</h1>
            </button>
        </div>
        ...
        >
            ...
            >
                <h1>"แผนของมันคือทำลายกำลังใจเรา </h1>
                <h1>ถ้าเราหลงกลมัน เราจะแพ้ สู้ไว้นะ"</h1>
            </button>
        </div>
