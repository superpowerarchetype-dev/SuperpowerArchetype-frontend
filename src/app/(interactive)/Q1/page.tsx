...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      >
        <h1>อะไรคือ 'ภาพ'</h1>
        <h1>แรกที่ปลุกไฟในตัวคุณให้ลุกโชน?</h1>
      </motion.div>
      ...
      >
        ...
        >
            ...
            >
                <h1>ภาพคนบริสุทธิ์ถูกปิดปากอย่างซึ่งหน้า</h1>
                <h1>คือสิ่งที่คุณทนดูไม่ได้</h1>
            </button>
        </div>
        ...
        >
            ...
            >
                <h1>ภาพเพื่อนบ้านที่เคยยิ้มให้กัน</h1>
                <h1>กลับมองกันด้วยความหวาดระแวง</h1>
            </button>
        </div>
        ...
        >
            ...
            >
                <h1>ภาพดวงตาว่างเปล่าของเด็กคนหนึ่งที่</h1>
                <h1>สะท้อนอนาคตอันมืดมน ถ้าไม่ทำอะไรสักอย่าง</h1>
            </button>
        </div>
