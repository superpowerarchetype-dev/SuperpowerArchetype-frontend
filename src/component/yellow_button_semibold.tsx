...
export default function YellowButtonSemibold({ text }: { text: string } , ) {
  ...
  return (
    ...
    >
      <button
        className="flex items-center justify-center font-semibold w-full h-full text-black rounded-[4px] text-center py-2"
